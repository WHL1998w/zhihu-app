		...
		<div class="column-bottom">
			<div class="bl-container">
				<div class="container1">
					<div class="column-card" v-for="(item, index) in pageColumns" :key="index">
						...
						<div class="column-middle">
							...
							<div class="font-space">
								<h5 class="colunm-font2">{{ item.description.substring(0, 20) }}</h5>
							</div>
							<h4 class="colum-font1">{{ item.followers }}关注|{{ item.aritclesCount }}文章</h4>
						</div>
						<div class="column-bottom">
			...
			<div class="column-container-mid-btn">
				<Button class="bl-btn bl-btn-round change-btn" outlined color="blue" @click="getBatch()">换一换</Button>
			</div>
		</div>
	</div>
	</div>
