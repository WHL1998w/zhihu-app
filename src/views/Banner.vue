<template>
	<div>
		<div class="nav-bar bl-shadow mb-2 fill-white">
			<transition name="nav-bar">
				<div class="bl-container bl-row" v-if="fixed">
					<div class="d-flex align-items-center bl-col-1">
					...
					<ul class="bl-fruid-col-2 bl-row justify-content-around">
					...
					<div class="bl-fruid-col-5 d-flex align-items-center pl-4">
						<input type="text" placeholder="请输入关键字" class="input-box mr-2" maxlength="100" />
						<button class="blue-fill-btn">提问</button>
					</div>

					<div class="bl-fruid-col-3 d-flex justify-content-end align-items-center nav-right">
						...
						<transition name="fade">
							<ul class="fill-white border bl-shadow profile-box" v-if="show">
			...
			<transition name="hide-bar">
				<div class="bl-container bl-row justify-content-around  hide-bar" v-if="!fixed">
					...
					<div class="bl-fruid-col-3 d-flex justify-content-end align-items-center">
						<input type="text" placeholder="请输入关键字" class="input-box mr-2" maxlength="100" />
						<button class="blue-fill-btn">提问</button>
					</div>
				</div>
